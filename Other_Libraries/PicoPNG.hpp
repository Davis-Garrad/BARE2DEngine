...
namespace BARE2D {
	...
	/**
	 * @brief Loads a PNG from a file. That's... All I've got
	 * @param out_image output parameter, this will contain the raw pixels after decoding. By default the output is 32-bit RGBA color. The std::vector is automatically resized to the correct size.
	 * @param image_width output_parameter, this will contain the width of the image in pixels.
	 * @param image_height output_parameter, this will contain the height of the image in pixels.
	 ...
	 * @param convert_to_rgba32 optional parameter, true by default.
