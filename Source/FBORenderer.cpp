...
void FBORenderer::createTextures()
{
	...
	case GL_DEPTH_ATTACHMENT:
	    ...
	    glTexImage2D(GL_TEXTURE_2D, 0, GL_DEPTH24_STENCIL8, m_camera->getViewspaceResolution().x,
	        m_camera->getViewspaceResolution().y, 0, GL_DEPTH_STENCIL, GL_UNSIGNED_INT_24_8, nullptr);
	    break;
	default:
	    // Just a regular texture.
	    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, m_camera->getViewspaceResolution().x,
	        m_camera->getViewspaceResolution().y, 0, GL_RGBA, GL_UNSIGNED_BYTE, nullptr);
	    break;
	}
