...
class Font
{
   public:
     ...
     * @param size The size of the font (in points). This is basically just the quality of the font loaded. Has nothing
     * to do with rendered size.
     */
   ...
   private:
    static std::vector<int>* createRows(glm::ivec4* rectangles,
