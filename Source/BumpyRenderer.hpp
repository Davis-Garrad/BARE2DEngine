...
namespace BARE2D {
	...
	/**
	 * @class BumpyRenderer
	 * @brief This is a BasicRenderer, but it includes the usage of bumpmaps. This can be useful for lighting. Has an additional uniform bumpmapSampler (sampler2D).
	 */
