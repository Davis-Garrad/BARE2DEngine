...
namespace BARE2D {
	 ...
	 * @brief A simple renderer. Has the GLSL VAOs vertexPosition (vec3), vertexColour (vec4), and vertexUV (vec2). Uniforms textureSampler (sampler2D), projectionMatrix (mat4)
	 */
