...
void TestScreen::draw()
{
	...
	for(unsigned int j = 0; j < yNum; j++) {
	    ...
	    m_renderer->draw(glm::vec4(pos.x + i * size.x, pos.y + j * size.y, size.x, size.y),
	        glm::vec4(0.0f, 1.0f, 1.0f, -1.0f), m_texture.id, m_textureNormal.id, depth);
	}
    }
    ...
    m_fontRenderer->draw(m_font_openSans, glm::vec2(1.0f), glm::vec4(pos.x, pos.y, size.x, size.y),
...
void TestScreen::onEntry()
{
    ...
    std::string texBMPath =
        "/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/152_norm.png";
    ...
    std::string fShaderPath_fbo =
        "/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/ShaderFBO.frag";
    ...
    std::string fontPath =
        "/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/OpenSans-Regular.ttf";
    ...
    std::string scriptPath =
        "/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/Lua/PrintTest.lua";
    ...
    std::string musicPath =
        "/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/SampleMusic.mus";
...
void TestScreen::update(double dt)
{
    ...
    m_renderer->getCamera()->offsetScale(
        m_inputManager->getMouseScrollwheelPosition() / 10.0f, m_inputManager->getMouseScrollwheelPosition() / 10.0f);
