...
int main(int argc, char **argv)
{
	...
	*dataTest.customFloatVector = std::vector<float>{1.0f, 1.0f, 2.0f, 3.0f, 5.0f, 8.0f, 13.0f};
	...
	BARE2D::Logger::getInstance()->log("Contextual information: \nCustom float data to be manipulated: " + std::to_string(*dataTest.customFloat) + "\nCustom vector data: " + tempString);

	BARE2D::Logger::getInstance()->log("BEGIN WRITE OPERATION", true);
	
	BARE2D::XMLDataManager::addData(&dataTest);
	BARE2D::XMLDataManager::saveXML("/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/XML/Write");
	...
	BARE2D::XMLDataManager::loadXML("/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/XML/Write");
	BARE2D::XMLDataManager::saveXML("/home/davis-dev/Documents/Programming/C++/CodingGithub/BARE2DEngine/BARETests/XML/Read");
